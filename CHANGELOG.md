...
- The classification is unchanged. The surface split affects wording and the diagram only, never the shape, and never leaks into the general lens. The golden suite is now 36 checks and covers both branches.
